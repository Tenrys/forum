<?php
    ...
    if (count($_POST) > 0) {
        ...
        if (!isset($error)) {
            ...
            try {
                $request = "UPDATE utilisateurs SET login = :login, password = :password, naissance = :naissance, bio = :bio WHERE id = :id;";
                ...
                if (!$success) echo $stmt->errorInfo()[2];
...
<form method="post">
    ...
    <br/>
    <textarea name="bio" maxlength="255" value="<?= $bio ?>"></textarea>
    <br/>
